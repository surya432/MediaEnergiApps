...
class MateriPengolahanScreen extends StatefulWidget {
  MateriPengolahanScreen({Key key}) : super(key: key);

  @override
  _MateriPengolahanScreenState createState() => _MateriPengolahanScreenState();
}
...
class _MateriPengolahanScreenState extends State<MateriPengolahanScreen> {
  @override
  void initState() {
    precacheImage(
        new AssetImage("assets/Icon/button-pengelolahan-01.png"), Get.context);
